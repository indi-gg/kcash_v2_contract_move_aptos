...
const module_path = "move/bulk_transfer"; // Path to the package which has the module
const output_file_path = "move/bulk_transfer/bulk_transfer.json"; // Path to JSON file
const address_name = "BulkTransfer"; // Address name from move.toml
...
const user2 = Account.fromPrivateKey({ privateKey: privateKeyOwner });
...
const owner = Account.fromPrivateKey({ privateKey: privateKeyuser2 });
